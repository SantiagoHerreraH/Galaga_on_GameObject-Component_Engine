...
namespace dae {
	...
	class CStatController final : public Component{
	public:
	...
	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::CreateStat(const StatKey& statKey, const Stat<StatValueType>& stat, bool* outChangedPrevious)
	{
	...
	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::RemoveStat(const StatKey& statKey)
	{
		m_Stats.erase(statKey);
	}

	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::ResetCurrentStat(const StatKey& statKey)
	{
	...
	template<typename StatKey, typename StatValueType>
	inline bool CStatController<StatKey, StatValueType>::HasStat(const StatKey& statKey) const
	{
		return m_Stats.contains(statKey);
	}

	template<typename StatKey, typename StatValueType>
	inline const Stat<StatValueType>& CStatController<StatKey, StatValueType>::GetStatStruct(const StatKey& statKey) const
	{
		return m_Stats.at(statKey);
	}

	template<typename StatKey, typename StatValueType>
	inline const StatValueType& CStatController<StatKey, StatValueType>::GetStat(const StatKey& statKey, StatCategory statCategory) const
	{
		switch (statCategory)
		{
	...
	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::SetStat(const StatKey& statKey, const StatValueType& value, StatCategory statCategory)
	{
		switch (statCategory)
		{
	...
	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::OffsetStat(const StatKey& statKey, const StatValueType& offset, StatCategory statType)
	{
		SetStat(statKey, GetStat(statKey, statType) + offset, statType);
	}

	template<typename StatKey, typename StatValueType>
	inline void CStatController<StatKey, StatValueType>::ScaleStat(const StatKey& statKey, const StatValueType& scalar, StatCategory statType)
	{
		SetStat(statKey, GetStat(statKey, statType) * scalar, statType);
	}

	template<typename StatKey, typename StatValueType>
	inline Event<>& CStatController<StatKey, StatValueType>::OnResetCurrentStatEvent(const StatKey& statKey)
	{
		return m_Stats.at(statKey).OnResetCurrentStat;
	}

	template<typename StatKey, typename StatValueType>
	inline Event<>& CStatController<StatKey, StatValueType>::OnCurrentStatZeroOrLess(const StatKey& statKey)
	{
		return m_Stats.at(statKey).OnCurrentStatZeroOrLess;
	}

	template<typename StatKey, typename StatValueType>
	inline Event<StatValueType>& CStatController<StatKey, StatValueType>::OnCurrentStatChange(const StatKey& statKey)
	{
