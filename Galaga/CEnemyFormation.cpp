...
void dae::CEnemyFormation::CreateSwirlFormationTimer()
{
	Scene& scene = SceneManager::GetInstance().GetCurrentScene();
	TimerSystem* TIMERSYSTEM = &TimerSystem::GetFromScene(&scene);
...
void dae::CEnemyFormation::CreateGrid()
{
	...
	m_Grid->SetRenderTransformSettings(true, {0,0,0});
...
dae::CButtonGrid* dae::Scene_MainMenu::MainMenuCreator::GetGrid()
{
